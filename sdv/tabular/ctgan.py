...
class CTGANModel(BaseTabularModel):
    ...
    def _fit(self, table_data):
        ...
        self._model.fit(
            ...
            metadata_top_layer = self.get_metadata()
        )
...
class CTGAN(CTGANModel):
    ...
    def __init__(self, field_names=None, field_types=None, field_transformers=None,
                 ...
                 log_frequency=True, verbose=False, epochs=300, cuda=True, external_eval_target=False, adaptive_training=True):
        super().__init__(
        ...
        self._model_kwargs = {
            ...
            'verbose': verbose,
            'epochs': epochs,
            'external_eval_target': external_eval_target,
