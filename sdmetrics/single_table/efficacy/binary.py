...
def f1_micro(real_target, predictions):
    return f1_score(real_target, predictions, average='micro')
...
class BinaryEfficacyMetric(MLEfficacyMetric):
    ...
    def _score(cls, scorer, real_target, predictions):
        ...
        return super()._score(scorer, real_target, predictions), real_target
    ...
    def _fit_predict(cls, synthetic_data, synthetic_target, real_data, real_target, dtypes=None):
        ...
        return super()._fit_predict(synthetic_data, synthetic_target, real_data, real_target, dtypes=dtypes)
